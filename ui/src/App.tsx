...
const WifiIcon     = () => <Icon d="M5 12.55a11 11 0 0 1 14.08 0M1.42 9a16 16 0 0 1 21.16 0M8.53 16.11a6 6 0 0 1 6.95 0M12 20h.01" />;
const WifiOffIcon  = () => <Icon d="M1 1l22 22M16.72 11.06A10.94 10.94 0 0 1 19 12.55M5 12.55a10.94 10.94 0 0 1 5.17-2.39M10.71 5.05A16 16 0 0 1 22.56 9M1.42 9a15.91 15.91 0 0 1 4.7-2.88M8.53 16.11a6 6 0 0 1 6.95 0M12 20h.01" />;
      ...
      <header style={{ background:'#0f172a', borderBottom:'1px solid #1e293b',
        ...
        <div style={{ maxWidth:1200, margin:'0 auto',
          ...
          <div style={{ display:'flex', alignItems:'center', gap:10, flexWrap:'wrap' }}>
            <div style={{ display:'flex', background:'#020817', border:'1px solid #1e293b',
              ...
              <input
                ...
                style={{ background:'transparent', color:'#34d399', fontSize:13,
                  padding:'8px 14px', width:230, fontFamily:'monospace',
                  border:'none', '::placeholder':{ color:'#334155' } }}
              />
              <button onClick={handleConnect}
                style={{ background:'#10b981', color:'#020817', fontWeight:700,
            ...
            <div style={{
              ...
              <span style={{ width:8, height:8, borderRadius:'50%', display:'block',
          ...
          {[
            ...
            <div key={i} style={{ background:'#0f172a', border:'1px solid #1e293b',
              ...
              <div style={{ fontSize:11, color:'#64748b', fontWeight:600,
                textTransform:'uppercase', letterSpacing:'0.08em' }}>{card.label}</div>
              <div style={{ fontSize:26, fontWeight:900, color:'#f1f5f9',
                marginTop:8, fontFamily:'monospace' }}>{card.value}</div>
              <div style={{ fontSize:11, color:'#475569', marginTop:3 }}>{card.sub}</div>
              <div style={{ position:'absolute', right:16, bottom:16, color:card.accent,
        ...
        <div style={{ display:'grid', gridTemplateColumns:'1fr 340px', gap:20,
              ...
              <div style={{ padding:'16px 22px', borderBottom:'1px solid #1e293b',
                ...
                <div style={{ display:'flex', gap:8 }}>
                  ...
                  <button onClick={() => fetchStatus(espBase)}
                    style={{ padding:6, borderRadius:8, background:'#020817',
                  ...
                  <thead>
                    <tr style={{ background:'#020817', position:'sticky', top:0 }}>
                      {['#','Time','Operator','ID','Machine','Shift','Event'].map(h => (
                        <th key={h} style={{ padding:'9px 16px', fontSize:11, fontWeight:700,
                          color:'#64748b', textTransform:'uppercase', letterSpacing:'0.07em',
                      ...
                      return (
                        <tr key={i} style={{ borderBottom:'1px solid #1e293b' }}>
                          <td style={{ padding:'11px 16px', fontSize:11,
                            color:'#475569', fontFamily:'monospace' }}>{num}</td>
                          <td style={{ padding:'11px 16px', fontSize:11,
                            color:'#64748b', fontFamily:'monospace', whiteSpace:'nowrap' }}>{e.time}</td>
                          <td style={{ padding:'11px 16px', fontWeight:600,
                            color:'#e2e8f0', fontSize:13 }}>{e.name}</td>
                          <td style={{ padding:'11px 16px', fontFamily:'monospace',
                            fontSize:11, color:'#34d399' }}>{e.id}</td>
                          <td style={{ padding:'11px 16px', fontSize:12,
                            color:'#94a3b8' }}>{e.machine}</td>
                          <td style={{ padding:'11px 16px', fontSize:12,
                            color:'#64748b' }}>{e.shift}</td>
          ...
          <div style={{ display:'flex', flexDirection:'column', gap:20 }}>
                    ...
                    <div key={op.id} style={{
                      ...
                      <div style={{ flex:1, minWidth:0 }}>
                        <div style={{ fontWeight:600, fontSize:13,
                          color: active ? '#f1f5f9' : '#94a3b8' }}>{op.name}</div>
                      ...
                      {active && (
                        <span style={{ fontSize:10, fontWeight:700, color:'#4ade80',
                          ...
                          padding:'2px 7px', borderRadius:99 }}>ACTIVE</span>
                      )}
                    </div>
                  );
                })}
            ...
            <div style={{ background:'#0f172a', border:'1px solid #1e293b',
              ...
              <div style={{ padding:'16px 20px', fontSize:12, display:'flex',
